...
SELECT Movement.id, Movement.material_id, Movement.work_id, Movement.amount, Movement.date, Movement.type, Material.name AS material_name, Material.units as material_units, Work.name AS work_name, Movement.description
