...
INSERT INTO Movement (person_id, material_id, work_id, amount, date, type) VALUES
    (1, 1, 1, 10, '2023-01-02', 'OUT'),
    (2, 2, 2, 15, '2023-02-16', 'OUT'),
    (3, 3, 3, 8, '2023-03-11', 'OUT'),
    (4, 4, 4, 5, '2023-04-06', 'OUT'),
    (5, 5, 5, 12, '2023-05-21', 'OUT'),
    (6, 6, 6, 7, '2023-06-16', 'OUT'),
    (7, 7, 7, 20, '2023-07-02', 'OUT'),
    (8, 8, 8, 10, '2023-08-11', 'OUT'),
    (9, 9, 9, 15, '2023-09-06', 'OUT'),
    (10, 10, 10, 8, '2023-10-21', 'OUT'),
    (11, 11, 11, 10, '2023-11-16', 'OUT'),
    (12, 12, 12, 5, '2023-12-02', 'OUT'),
    (13, 13, 13, 15, '2024-01-11', 'OUT'),
    (14, 14, 14, 7, '2024-02-06', 'OUT'),
    (15, 15, 15, 12, '2024-03-21', 'OUT');
